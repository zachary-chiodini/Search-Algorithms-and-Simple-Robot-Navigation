...
<p style="text-align:justify">
  ...
  When children of a node are generated by the successor, this is termed "expanding" the node.
  The action taken to reach each child state is represented by branches connecting the parent node to the child nodes. 
